...
async function getEmployeeHourlyRate(req, res, next) {
  try {
    const { data, meta } = await reportService.getEmployeeHourlyRate(req.query);
...
async function getMonthlyCostSummary(req, res, next) {
  try {
    const { data, meta, summary } = await reportService.getMonthlyCostSummary(req.query);
...
async function getTimesheetSummary(req, res, next) {
  try {
    const { data, meta, summary } = await reportService.getTimesheetSummary(req.query);
    const response = { records: data, summary };
...
async function getServicePOUtilisation(req, res, next) {
  try {
    const { data, meta } = await reportService.getServicePOUtilisation(req.query);
...
async function getSubProjectHours(req, res, next) {
  try {
    const { data, meta, summary } = await reportService.getSubProjectHours(req.query);
    const response = { records: data, summary };
...
async function getResourceAllocation(req, res, next) {
  try {
    const { data, meta } = await reportService.getResourceAllocation(req.query);
...
async function getOperationalCostBreakdown(req, res, next) {
  try {
    const { data, meta, summary } = await reportService.getOperationalCostBreakdown(req.query);
    const response = { records: data, summary };
