...
const createSubProjectSchema = Joi.object({
  sub_project_code: Joi.string()
    ...
    .required()
    .messages({
      'string.pattern.base': 'Sub-project code must be 2-30 uppercase alphanumeric characters (hyphens, underscores, slashes allowed).',
      'string.empty': 'Sub-project code is required.',
      'any.required': 'Sub-project code is required.',
    }),
